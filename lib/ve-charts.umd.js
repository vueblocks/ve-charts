...
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__1523__, __WEBPACK_EXTERNAL_MODULE__8bbf__, __WEBPACK_EXTERNAL_MODULE_df8e__) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE_df8e__;
...
class chart_PieChart extends src_BaseChart {
  ...
  static getPieSeries (args) {
    ...
    if (data.length === undefined) {
      series = chart_PieChart.handleData(data, settings, isDonut)
    } else if (data.length === 1) {
      series = chart_PieChart.handleData(data[0], settings, isDonut)
    } else if (data.length === 2) {
      for (let index in data) {
        series.push(chart_PieChart.handleData(data[index], settings[index], isDonut, index)[0])
      }
    }
    return series
  }
  ...
  static chartHandler (data, settings, extra, isDonut = false) {
    ...
    const legend = legendVisible && chart_PieChart.getPieLegend({ settings })
...
class chart_GeoChart extends src_BaseChart {
  ...
  static getGeoData (args) {
    ...
    measures && measures.forEach(({ name, data }, index) => {
      const mapData = isMapMode ? data : chart_GeoChart.convertCityData(data, { index, connect })
  ...
  async geo (data, settings, extra) {
    ...
    const { legendData, seriesData, max } = chart_GeoChart.getGeoData({ data, settings })

    const tooltip = tooltipVisible && chart_GeoChart.getGeoTooltip(isMapMode)
    ...
    const geoVisualMap = visualMapVisible && chart_GeoChart.getVisualMap({ max, settings })
...
/* concated harmony reexport VeDonutChart */__webpack_require__.d(__webpack_exports__, "VeDonutChart", function() { return donut; });
/* concated harmony reexport VeFunnelChart */__webpack_require__.d(__webpack_exports__, "VeFunnelChart", function() { return funnel; });
/* concated harmony reexport VeGaugeChart */__webpack_require__.d(__webpack_exports__, "VeGaugeChart", function() { return gauge; });
/* concated harmony reexport VeGeoChart */__webpack_require__.d(__webpack_exports__, "VeGeoChart", function() { return geo; });
/* concated harmony reexport VeLineChart */__webpack_require__.d(__webpack_exports__, "VeLineChart", function() { return line; });
/* concated harmony reexport VePieChart */__webpack_require__.d(__webpack_exports__, "VePieChart", function() { return pie; });
/* concated harmony reexport VeRadarChart */__webpack_require__.d(__webpack_exports__, "VeRadarChart", function() { return radar; });
/* concated harmony reexport VeScatterChart */__webpack_require__.d(__webpack_exports__, "VeScatterChart", function() { return scatter; });
/* concated harmony reexport VeTreemapChart */__webpack_require__.d(__webpack_exports__, "VeTreemapChart", function() { return treemap; });
/* concated harmony reexport VeSunburstChart */__webpack_require__.d(__webpack_exports__, "VeSunburstChart", function() { return sunburst; });
/* concated harmony reexport VeTreeChart */__webpack_require__.d(__webpack_exports__, "VeTreeChart", function() { return tree; });
/* concated harmony reexport VeWordcloudChart */__webpack_require__.d(__webpack_exports__, "VeWordcloudChart", function() { return wordcloud; });
/* concated harmony reexport VeLiquidfill */__webpack_require__.d(__webpack_exports__, "VeLiquidfill", function() { return liquidfill; });
