...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-demi'), require('echarts/core'), require('echarts/charts'), require('lodash.clonedeep'), require('echarts/components'), require('echarts/renderers'), require('@vueblocks/vue-use-core')) :
  typeof define === 'function' && define.amd ? define(['vue-demi', 'echarts/core', 'echarts/charts', 'lodash.clonedeep', 'echarts/components', 'echarts/renderers', '@vueblocks/vue-use-core'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VeLineChart = factory(global.VueDemi, global.EchartsCore, global.EchartsCharts, global.CloneDeep, global.EchartsComponents, global.EchartsRenderers, global.VueUseCore));
}(this, (function (vueDemi, core, charts, cloneDeep, components, renderers, vueUseCore) { 'use strict';
  ...
  core.use([charts.LineChart]);
  var VeLineChart = vueDemi.defineComponent({
      name: 'VeLineChart',
      extends: HocChart,
      setup(props) {
          console.log(props);
